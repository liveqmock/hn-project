...
<html>
<head>
	<title>scenicMessage新增</title>
</head>

<body>
	<form id="inputForm" action="${ctx}/scenicMessage/add" method="post" class="form-horizontal">
		<fieldset>
			<legend><small>scenicMessage新增</small></legend>
			<!--
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <input type="text" id="dataValueIdKnow" name="dataValueIdKnow" class="input-large" />
                </div>
            </div>
            <div class="control-group">
                <label class="control-label">景点介绍:</label>
                <div class="controls">
                    <input type="text" id="dataValueIdIntroduce" name="dataValueIdIntroduce" class="input-large" />
                </div>
            </div>
            <div class="control-group">
